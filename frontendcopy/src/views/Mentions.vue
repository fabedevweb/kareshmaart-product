<template>
  <div>
    <div class="container bg-dark text-white">
      <h1 class="pt-5 pb-5">MENTIONS LEGALES</h1>
      <div class="fs-4 text-justify container pb-5">
        <p class="text-justify">
          ...
          <a
            ...
            href="https://www.kareshmaart.com"
        ...
        <h2 class="mt-5">1. Présentation du site internet.</h2>
        <p>
        ...
        <p>
          <strong>Propriétaire</strong> : XXX KareshmaArt Capital social de
          00000€ Numéro de TVA: 000000 – xxxx 00000 Vacoas<br />

          <strong>Responsable publication</strong> : NOURSAÏ Kareshma –
          fabrice@ilemauriceinside.fr<br />
          Le responsable publication est une personne physique ou une personne
          morale.<br />
          <strong>Webmaster</strong> : Avrila – fabrice@ilemauriceinside.fr<br />
          <strong>Hébergeur</strong> : o2switch – 222 Bd Gustave Flaubert 63000
          Clermont-Ferrand, France +33 4 44 44 60 40<br />
          <strong>Délégué à la protection des données</strong> : XXX –
          fabrice@ilemauriceinside.fr<br />
        </p>
        ...
        <h2 class="mt-5">3. Description des services fournis.</h2>
        ...
        <h2 class="mt-5">5. Propriété intellectuelle et contrefaçons.</h2>
        ...
        <h2 class="mt-5">6. Limitations de responsabilité.</h2>
        ...
        <h2 class="mt-5">7. Gestion des données personnelles.</h2>
        ...
        <p>
          ...
          <a
            ...
            href="https://www.kareshmaart.com"
            >https://www.kareshmaart.com</a
          >est représenté par NOURSAÏ Kareshma, son représentant légal
        </p>
        ...
        <h2 class="mt-5">8. Notification d’incident</h2>
        <p>
        ...
        <p>
          ...
          déposer des cookies sur vos terminaux (ordinateur, tablette, téléphone
          portable).
        </p>
        <p>
